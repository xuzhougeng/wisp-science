...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "skills.button") => Some("Skills"),
        (Locale::En, "skills.manage") => Some("Manage skills"),
        (Locale::En, "skills.title") => Some("Skills"),
        (Locale::En, "skills.search") => Some("Search skills..."),
        ...
        (Locale::Zh, "skills.button") => Some("技能"),
        (Locale::Zh, "skills.manage") => Some("管理技能"),
        (Locale::Zh, "skills.title") => Some("技能"),
        (Locale::Zh, "skills.search") => Some("搜索技能…"),
