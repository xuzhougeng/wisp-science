...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "conn.biotools") => Some("Bio-tools (built-in)"),
        (Locale::En, "conn.biotools.desc") => Some("Bundled bioinformatics MCP servers."),
        ...
        (Locale::Zh, "conn.biotools") => Some("Bio-tools（内置）"),
        (Locale::Zh, "conn.biotools.desc") => Some("内置的生物信息学 MCP 服务。"),
