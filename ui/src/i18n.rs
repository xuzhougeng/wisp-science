...
fn lookup(locale: Locale, key: &str) -> Option<&'static str> {
    match (locale, key) {
        ...
        (Locale::En, "composer.hint") => Some("Enter to send · Shift+Enter for newline · Drag top edge to resize · Drop files/folders to attach paths · Paste images to upload"),
        (Locale::En, "composer.resize_hint") => Some("Drag to resize input height"),
        (Locale::En, "composer.attach") => Some("Attach"),
        (Locale::En, "composer.drop_hint") => Some("Release to attach file/folder paths"),
        ...
        (Locale::Zh, "composer.hint") => Some("Enter 发送 · Shift+Enter 换行 · 拖拽上边缘调整高度 · 拖放文件/文件夹可附加路径 · 粘贴图片可上传"),
        (Locale::Zh, "composer.resize_hint") => Some("拖拽调整输入框高度"),
        (Locale::Zh, "composer.attach") => Some("附加"),
        (Locale::Zh, "composer.drop_hint") => Some("松开以附加文件/文件夹路径"),
